...
async function main() {
  ...
  await processIngest(
    {
      householdId: hhId,
      accountId: created.checking,
      sourceId: sources.checking,
    ...
    },
    {
      transactions: [
        ...
        { date: '2025-03-03', amount: -1800.0, description: 'Mortgage Payment', isTransfer: true },
        {
          date: '2025-03-05',
          amount: -142.37,
        ...
        { date: '2025-03-06', amount: -65.0, description: 'Electric Bill', category: 'utilities' },
        { date: '2025-03-07', amount: -12.5, description: 'Netflix', category: 'entertainment' },
        {
          date: '2025-03-08',
          amount: -45.8,
  ...
  await processIngest(
    {
      householdId: hhId,
      accountId: created.retirement,
      sourceId: sources.retirement,
      sourceType: 'manual_entry',
    },
    {
      transactions: [],
      investmentActivity: [
        ...
        { date: '2025-03-05', activityType: 'dividend', symbol: 'VTI', amount: 42.3 },
        {
          date: '2025-03-05',
      ...
      balances: [{ date: '2025-03-08', balance: 187542.0 }],
      holdings: [
        {
          asOf: '2025-03-08',
          symbol: 'VTI',
        ...
        },
        {
          asOf: '2025-03-08',
          symbol: 'VXUS',
          name: 'Vanguard Intl Stock Market ETF',
          quantity: 285.0,
          price: 58.8,
          marketValue: 16758.0,
          costBasis: 15100.0,
  ...
  await processIngest(
    {
      householdId: hhId,
      accountId: created.credit,
      sourceId: sources.credit,
      sourceType: 'manual_entry',
    },
    {
      transactions: [
        { date: '2025-03-02', amount: -89.0, description: 'Amazon.com', category: 'shopping' },
        { date: '2025-03-04', amount: -34.5, description: 'Uber Eats', category: 'dining' },
        { date: '2025-03-06', amount: -250.0, description: 'Delta Airlines', category: 'travel' },
        {
          date: '2025-03-07',
          amount: 1500.0,
      ...
      investmentActivity: [],
      balances: [{ date: '2025-03-08', balance: -873.5 }],
      holdings: [],
    },
  );
  ...
  const { data: txnCount } = await supabase
    ...
    .eq('account_id', created.checking);
  console.log(
    `Checking txns after re-ingest: ${txnCount!.length} (should still be 6 — dupes ignored)`,
  );
